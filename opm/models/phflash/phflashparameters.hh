...
//! [K] lower bound of the temperature search bracket
template<class Scalar>
struct PhFlashTempMin { static constexpr Scalar value = 200.0; };

//! [K] upper bound of the temperature search bracket
template<class Scalar>
struct PhFlashTempMax { static constexpr Scalar value = 600.0; };
